...
set rootfolder=C:\Users\user\cursor\project\portfolio\actions-runner
set existrunnerversion=2.311.0
set downloadrunnerversion=2.323.0
set logfile=C:\Users\user\cursor\project\portfolio\actions-runner\_diag\SelfUpdate-20250423-152608.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\Users\user\cursor\project\portfolio\actions-runner\run.cmd"
) else (
  endlocal
)
